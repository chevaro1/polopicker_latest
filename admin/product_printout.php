    ...
    <?php include('../blocks/admin_nav.php') ?>
          ...
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            <div class="container">
              <div class="row">
                <div class="col-4">
                  <h3>Product Printout</h3>
                  <p>Please select a product and all products within that product type will be printed out</p>
                </div>
                <div class="col-5 my-auto">
                  <div class="input-group mb-3">
                    ...
                    <select class="custom-select" id="prodtype">
      ...
      <?php include('../blocks/admin_footer_scripts.php') ?>
			<script src="../js/product_printout.js"></script>
