          ...
          <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            <div class="container">
              ...
              <div class="row">
                <div class="col-4">
                  <h3>Search Data</h3>
                  <p class="font-weight-bold">Here you can view all search data from the main website</p>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-8">
                      <div class="input-group pt-1">
                        ...
                        <select class="custom-select" id="search-timeframe">
                    ...
                    <div class="col-4">
                      <div class="card bg-secondary text-white">
                        ...
                        <div class="card-body text-center">
                          <h3 class="card-text" id="total-searches"></h3>
                        </div>
                      </div>
                      <div class="card bg-secondary text-white mt-3">
                        ...
                        <div class="card-body">
                          <h3 class="card-text" id="average-searches"></h3>
                        </div>
                      </div>
                    </div>
                    <div class="col-8">
